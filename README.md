...
What is shown here are images generated by the base model (aligned with the prompt but not specific to the dataset) and images generated by the fine-tuned model (aligned with both the prompt and the dataset).
