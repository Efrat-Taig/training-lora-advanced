...
#####################################################
# This code is based: https://github.com/huggingface/diffusers/blob/main/examples/dreambooth/train_dreambooth_lora_flux.py
...
def main(args):
    ...
    noise_scheduler = FlowMatchEulerDiscreteScheduler.from_pretrained(args.pretrained_model_name_or_path, subfolder='scheduler', shift=4, use_dynamic_shifting=False)
    ...
    transformer = BriaTransformer2DModel.from_pretrained(args.pretrained_model_name_or_path, subfolder='transformer')
